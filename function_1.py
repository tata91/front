...
print('getNumberOfConnectedComponents:',end=':')
print(getNumberOfConnectedComponents(G))

print('getNumberOfCliques:',end=':')
print(getNumberOfCliques(G))

print('getNumberOfStronglyConnectedComponents:',end=':')
#print(getNumberOfStronglyConnectedComponents(G))

print('getNumberOfWeaklyConnectedComponents:',end=':')
#print(getNumberOfWeaklyConnectedComponents(G))

print('getNumberOfIsolate:',end=':')
print(getNumberOfIsolates(G))

print('getDegreeCentrality:',end=':')
print(getDegreeCentrality(G))

print('getBetweenessCentrality:',end=':')
print(getBetweenessCentrality(G))

print('getAllPairsShortestPath:',end=':')
print(getAllPairsShortestPath(G))

print('getAllPairsNodeConnectivity:',end=':')
print(getAllPairsNodeConnectivity(G))

print('getClosenessCentrality:',end=':')
print(getClosenessCentrality(G))

print('getBridges:',end=':')
print(getBridges(G))

print('getConnectedComponents:',end=':')
print(getConnectedComponents(G))

print('getDiameter:',end=':')
print(getDiameter(G))

print('getKatzCentrality:',end=':')
print(getKatzCentrality(G))

print('getPageRank:',end=':')
print(getPageRank(G))

print('getTriangles:',end=':')
print(getTriangles(G))

print('getNeighbours:',end=':')
print(getNeighbours(G))
'''
